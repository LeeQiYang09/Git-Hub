...
public class Registration extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    EditText username, name, phoneNumber, password, confirmPassword, email, address, afterRoleBox, afterRoleBox1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        StringRequest accCount = new StringRequest(
                ...
                response -> count = Integer.parseInt(response),
                error -> Toast.makeText(Registration.this, "Accounts Count :" + error.toString(), Toast.LENGTH_LONG).show()
        );
    ...
    private void setRegisterButton(View view)
    {
        /*if (!fieldValidation())
        {
            Toast.makeText(Registration.this, "test", Toast.LENGTH_LONG).show();
            return;
        }*/
        ...
        try{
            ...
            Toast.makeText(Registration.this, "Name: " + name.getText().toString(),
        ...
        {
            Toast.makeText(Registration.this, "Registration JSON error: " + ex.toString(),
                    Toast.LENGTH_LONG).show();
            return;
        }
        ...
        StringRequest request = new StringRequest(
                ...
                error -> Toast.makeText(Registration.this, "Registration JSON error: " + error.toString(),
                        Toast.LENGTH_LONG).show()
        )
        {
            @Override
