...
public class MainActivity extends AppCompatActivity {
    ...
    public static JSONObject receiverDetails;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Layout that is bound to this class
    ...
    private void setLoginBtn(View view) {
        ...
        Intent i = new Intent(MainActivity.this, Acc_Receiver.class);
                    ...
                    response ->
                    {
                        ...
                        try {
                            ...
                            if (result.equals("Success")) {
                                ...
                                if (response.getString("accType").equals("Receiver"))
                                {
                                ...
                                else
                                {
                                    Toast.makeText(MainActivity.this,
                                            "The account you are logging in is not a Receiver account, please check with administrator!",
